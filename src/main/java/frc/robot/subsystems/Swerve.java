...
public class Swerve extends SubsystemBase {
  ...
  public void resetOdometry(Pose2d pose) {
    ...
    swerveOdometry.resetPosition(getYaw(), new SwerveModulePosition[]{
      mSwerveMods[0].getPosition(), mSwerveMods[1].getPosition(), mSwerveMods[2].getPosition(), mSwerveMods[3].getPosition()}, pose);
  }
  ...
  public Rotation2d getYaw() {
    return (Constants.Swerve.invertGyro)
        ? Rotation2d.fromRadians(360 - gyro.getYaw())
  ...
  public void periodic() {
    ...
    for (SwerveModule mod : mSwerveMods) {
      SmartDashboard.putNumber(
          "Mod " + mod.moduleNumber + " Cancoder", mod.getCanCoder().getRadians());
      SmartDashboard.putNumber(
          "Mod " + mod.moduleNumber + " Integrated", mod.getState().angle.getRadians());
      SmartDashboard.putNumber(
